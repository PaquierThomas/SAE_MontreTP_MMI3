      ...
      <form @submit.prevent="addWatch">
        ...
        <div>
          ...
          >
            ...
            <option value="3" @click="changeTextureBoitierRond('background_fluo01.png')">
              Fluo
            </option>
            <option value="4" @click="changeTextureBoitierRond('background_mickey.png')">
              Mickey
            </option>
            <option value="5" @click="changeTextureBoitierRond('background_white01.png')">
              Neon
            </option>
            <option value="6" @click="changeTextureBoitierRond('background_white02.png')">
              Clock
            </option>
